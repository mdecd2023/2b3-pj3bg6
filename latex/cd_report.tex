...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    {\begin{minipage}[t]{10em}\underline{四設二乙\enspace 41023203\enspace 莊雨薰}\\ \underline{四設二乙\enspace 41023204\enspace 陳妤瑄}\\ \underline{四設二乙\enspace 41023205\enspace 陳靚芸}\\ \underline{四設二乙\enspace 41023206\enspace 陳澤瑜}\\ \underline{四設二乙\enspace 41023207\enspace 楊舒涵}\\ \underline{四設二乙\enspace 41023208\enspace 廖子儀}\\ \underline{四設二乙\enspace 41023210\enspace 鄭翊均}\\ \underline{四設二乙\enspace 41023255\enspace 徐佑寧}\\ %下劃線符號指令
    \end{minipage}}
    \hspace*{\fill} \\
         \par} %結束指定行距
    ...
    {\begin{flushleft}
    \fontsize{16pt}{16pt}\selectfont \makebox[6em][s]{指導老師}\enspace:\quad \underline{嚴家銘老師}\\[10pt]
    \hspace*{\fill} \\
    \fontsize{16pt}{2.5pt}\selectfont \makebox[12em][s]{中華民國一一二年}\hspace{2pt}
    \fontsize{16pt}{2.5pt}\selectfont\makebox[8em][s]{六月三十日}
    \end{flushleft}}
    \end{textblock}}
    \end{textblock}}
     \par} %結束指定行距
...
\begin{flushleft}
\fontsize{14pt}{2.5pt}\hspace{12pt}\quad 在此鄭重感謝製作以及協助本分組報告完成的所有人員，首先向老師致謝，他不辭辛勞解決我們的提問，甚至從來沒有不耐煩，總是貼心為我們找出最佳解答。最後是由本分組組員同心協力才得以完成本報告，特此感謝。
\end{flushleft}
\newpage
%=------------------------目錄----------------------=%
...
%=-------------作者簡介-----------------=%
    ...
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{莊雨薰}\\ \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{41023203} \\ %\makebox為文本盒子
    \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{GitHub帳號}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[9em][s]{SHIUN129}\\
    \end{textblock}}}
    %\hspace*{\fill} \\
    \vspace{2em}
	...
	\includegraphics[width=1.15in]{member2}  %作者照片
        ...
        \noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{陳妤瑄}\\ 
    \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{41023204} \\ 
    \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{GitHub帳號}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[9em][s]{04yxuan}\\
    \end{textblock}}}
    %\hspace*{\fill} \\
    \vspace{2em}
	{\begin{textblock}{6}(0,2.3)
	...
	\includegraphics[width=1.15in]{member2}  %作者照片
        ...
        {\begin{textblock}{15}(3.5,2.5) %{寬度}(以左上角為原點之右移量,下移量)
        \noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{陳靚芸}\\ 
    \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{41023205} \\ 
    \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{GitHub帳號}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[9em][s]{c-ching}\\
    \end{textblock}}}
   %\hspace*{\fill} \\
    \vspace{2em}
	{\begin{textblock}{6}(0,2.3)
	...
	\includegraphics[width=1.15in]{member2}  %作者照片
        ...
        {\begin{textblock}{15}(3.5,2.5) %{寬度}(以左上角為原點之右移量,下移量)
        \noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{陳澤瑜}\\ 
    \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{41023206} \\ 
    \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{GitHub帳號}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[9em][s]{tseYU000}\\
    \end{textblock}}}
\newpage
    \addcontentsline{toc}{chapter}{作者簡介}
    \begin{center}
	...
	{\begin{textblock}{15}(3.5,0.7)%{寬度}(以左上角為原點之右移量,下移量)
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{楊舒涵}\\ \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{41023207} \\ %\makebox為文本盒子
    \hspace*{\fill} \\
    \fontsize{14pt}{0em}\selectfont \makebox[4em][s]{GitHub帳號}\enspace:\enspace
    \fontsize{14pt}{0em}\selectfont \makebox[9em][s]{chiiip333}\\
    \end{textblock}}}
    %\hspace*{\fill} \\
    \vspace{2em}
	...
	\noindent\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{廖子儀}\\ \hspace*{\fill} \\
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{41023208} \\ \hspace*{\fill} \\
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{GitHub帳號}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[9em][s]{ziyi8}\\
    \end{textblock}}
    %\hspace*{\fill} \\
    \vspace{2em}
    {\begin{textblock}{6}(0,7.7)
    ...
    {\begin{textblock}{15}(3.5,7.9) %{寬度}(以左上角為原點之右移量,下移量)
	\noindent\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{鄭翊均}\\ \hspace*{\fill} \\
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{41023210} \\ \hspace*{\fill} \\
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{GitHub帳號}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[9em][s]{junpig10}\\
    \end{textblock}}
    %\hspace*{\fill} \\
    \vspace{2em}
    {\begin{textblock}{6}(0,7.7)
    ...
    {\begin{textblock}{15}(3.5,7.9) %{寬度}(以左上角為原點之右移量,下移量)
	\noindent\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{徐佑寧}\\ \hspace*{\fill} \\
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{41023255} \\ \hspace*{\fill} \\
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{GitHub帳號}\enspace:\enspace
	\noindent\fontsize{14pt}{0em}\selectfont \makebox[9em][s]{A41023255}\\
    \end{textblock}}
\newpage
%=----------------書背----------------------=%
